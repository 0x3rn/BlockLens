...
import { Coin, CurrencyCode, MarketMetrics, PortfolioPosition, PriceAlert, AlertCondition } from '../types/crypto';
...
export const MarketProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const { positions, upsertPosition, removePosition } = usePortfolio();
